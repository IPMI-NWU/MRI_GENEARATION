...
tf.flags.DEFINE_string('input_dataB', r'E:\baobaocode\SpineC2M\Tumor_concat', 'data B input directory, default: ../test')
# tf.flags.DEFINE_string('output_dataA', 'test_selectedhebin', 'data A output directory, default: train')
tf.flags.DEFINE_string('output_dataB', 'train_tf', 'data B output directory, default: test')
...
def data_writer(input_dir, output_name, extension='.png'):
    ...
    output_file = r'E:\baobaocode\SpineC2M\Tumor_concat\{}.tfrecords'.format(output_name)
...
def data_reader(input_dir, extension='.png', is_shuffle=False):
    file_paths = []
